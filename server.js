...
app.post("/api/ai/report", async (req, res) => {
  try {
    ...
    1. **ORIGEN DE LOS DATOS:**
       - Stock: Tabla \`stock.quant\` de Odoo.
       - Valor (€): \`stock.quant.quantity\` * \`product.product.standard_price\`.
       - NUNCA DIGAS "según el contexto". DI: "He consultado Odoo y..."
    ...
    2. **INTEGRIDAD FINANCIERA:**
       ...
       - Items Auditados: ${itemsWithCost.toLocaleString()} productos únicos con coste asignado.
